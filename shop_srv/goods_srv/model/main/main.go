...
func main() {
	//dsn := "root:123456@tcp(127.0.0.1:3306)/goods_test?charset=utf8mb4&parseTime=True&loc=Local"
...
func Mysql2Es() {
	dsn := "root:123456@tcp(192.168.61.33:3306)/shop_goods_srv?charset=utf8mb4&parseTime=True&loc=Local"
